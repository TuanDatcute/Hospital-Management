...
/**
 *
 * @author ADMIN (Đã NÂNG CẤP: Chuyển sang Xóa Mềm, giữ nguyên tên hàm)
 */
public class KhoaDAO {
    ...
    /**
     * === SỬA (XÓA MỀM) === Hàm delete(int id) của bạn giờ sẽ thực hiện Xóa
     * Mềm.
     */
    ...
    /**
     * HÀM BỔ SUNG (CHO VALIDATION): Tìm khoa bằng Tên (Service cần hàm này để
     * kiểm tra logic Update)
     */
