...
<html>
    ...
    <body>
        ...
        <div class="container page-content" style="padding-top: 30px;">
            ...
            <%-- (Các thông báo sessionScope giữ nguyên) --%>
                    ...
                    <c:forEach var="nv" items="${requestScope.LIST_NHANVIEN}">
                        <tr>
                            ...
                            <td>
                                ...
                                <td class="actions">
                                <%-- (Logic Sửa và Xóa POST giữ nguyên như file trước) --%>
            ...
            <div class="pagination-container">
                ...
                <c:if test="${totalPages > 1}">
                    <%-- Nút Trang Trước --%>
                    <%-- c:url sẽ tự động thêm param 'keyword' nếu nó tồn tại --%>
            ...
            <%-- === KẾT THÚC SỬA (PHÂN TRANG + TÌM KIẾM) === --%>
